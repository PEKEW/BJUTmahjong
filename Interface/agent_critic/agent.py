...
class Agent(object):
    ...
    def resume(self, path_model, path_feature=None, load_optimizer=True):
        ...
        self.alg.load_state_dict(checkpt["state_dict"])
    ...
    def predict(self, obs):
        action_feature, action, input = self.alg.policy(obs)
    ...
    def learn_fast(self, critic, ps_weight=2.0):
        ...
        play_batch = {"target": "play", "feature": [], "mask": [], "last_reward": [], "global_feature": [],
                      "previous_global_feature": [], "ps_feature": []}
        richi_batch = {"target": "richi", "feature": [], "mask": [], "last_reward": [], "global_feature": [],
                       "previous_global_feature": []}
        others_win_batch = {"target": "others_win", "feature": [], "last_reward": [], "global_feature": [],
                            "previous_global_feature": []}
        others_gang_batch = {"target": "others_gang", "feature": [], "last_reward": [], "global_feature": [],
                             "previous_global_feature": [], "id": []}
        others_peng_batch = {"target": "others_peng", "feature": [], "last_reward": [], "global_feature": [],
                             "previous_global_feature": [], "id": []}
        ...
        for exp in experience:
            ...
            if target == "gang":
                ...
                with torch.no_grad():
                    ...
                    reward = critic(global_feature) - last_reward
                ...
                richi_batch["last_reward"].append(torch.tensor(exp["last_reward"]).cpu() if not isinstance(exp["last_reward"], torch.Tensor) else exp["last_reward"].cpu())
                ...
                play_batch["last_reward"].append(torch.tensor(exp["last_reward"]).cpu() if not isinstance(exp["last_reward"], torch.Tensor) else exp["last_reward"].cpu())
                ...
                others_win_batch["last_reward"].append(torch.tensor(exp["last_reward"]).cpu() if not isinstance(exp["last_reward"], torch.Tensor) else exp["last_reward"].cpu())
                ...
                others_gang_batch["last_reward"].append(torch.tensor(exp["last_reward"]).cpu() if not isinstance(exp["last_reward"], torch.Tensor) else exp["last_reward"].cpu())
                ...
                others_peng_batch["last_reward"].append(torch.tensor(exp["last_reward"]).cpu() if not isinstance(exp["last_reward"], torch.Tensor) else exp["last_reward"].cpu())
